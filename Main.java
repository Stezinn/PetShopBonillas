    ...
    public static void main(String[] args) {
        ...
        while (!opcao.equals("7")) {
            opcao = JOptionPane.showInputDialog("Selecione uma opção:\n\n" +
                    ...
                    "2 - Cadastrar Dono\n" +
                    "3 - Banho ou Tosa\n" +
                    "4 - Mostrar todos os animais de um Dono\n" +
                    "5 - Listar todos os Donos de pets\n" +
                    "6 - Calcular total ganho\n" +
                    "7 - Sair" +
                    "\n\n");
...
//    Deve ser possível cadastrar um id e um nome para o pet. Além disso, se o pet for cachorro, poderemos cadastrar a raça e o porte dele (pequeno, médio ou grande). Já se o pet for gato, deve ser possível registrar se ele solta pelos ou não.
...
//    Preciso cadastrar os banhos e tosas que realizo. CADASTAR TODOS OS BANHOS E TOSAS
//    O banho e tosa de um cachorro custa de acordo com o porte dele. Porte pequeno custa 20 reais, porte médio custa 40 reais e porte grande custa 60 reais. Se o cachorro for da raça pitbull, eu cobro um adicional de 10 reais, por causa do risco que ele me oferece. Já o banho e tosa de um gato, se ele não solta pelos, custa 20 reais, e se ele soltar pelos custa 30 reais, pois tenho que usar um shampoo anti-queda que é mais caro.
//    Por fim, preciso conseguir ver quantos reais eu ganhei com todos os banhos e tosas que realizei. TOTAL GANHO OKKKKKK
//    Preciso ter um menu para poder acessar as funcionalidades. OOKKKKKKKK
//    NãO PRECISA USAR BANCO DE DADOS, MAS SE QUISEREM PODEM USAR OKKKKKKKKKK
